...
{
    default gLoan.LoanConfirmation takeLoan(gLoan.Loan loan)
        throws gExceptions.TakeLoanException
    {
        return takeLoan(loan, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default gLoan.LoanConfirmation takeLoan(gLoan.Loan loan, java.util.Map<String, String> context)
        throws gExceptions.TakeLoanException
    {
        try
        {
            return _iceI_takeLoanAsync(loan, context, true).waitForResponseOrUserEx();
        }
        catch(gExceptions.TakeLoanException ex)
        {
            throw ex;
        }
    ...
    default java.util.concurrent.CompletableFuture<gLoan.LoanConfirmation> takeLoanAsync(gLoan.Loan loan)
    {
        return _iceI_takeLoanAsync(loan, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<gLoan.LoanConfirmation> takeLoanAsync(gLoan.Loan loan, java.util.Map<String, String> context)
    {
        return _iceI_takeLoanAsync(loan, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<gLoan.LoanConfirmation> _iceI_takeLoanAsync(gLoan.Loan iceP_loan, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<gLoan.LoanConfirmation> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "takeLoan", null, sync, _iceE_takeLoan);
        f.invoke(true, context, null, ostr -> {
                     gLoan.Loan.ice_write(ostr, iceP_loan);
                 }, istr -> {
                     gLoan.LoanConfirmation ret;
                     ret = gLoan.LoanConfirmation.ice_read(istr);
                     return ret;
                 });
        return f;
    }

    static final Class<?>[] _iceE_takeLoan =
    {
        gExceptions.TakeLoanException.class
    };
