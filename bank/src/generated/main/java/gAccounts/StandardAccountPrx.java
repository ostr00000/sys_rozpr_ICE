...
{
    default AccountInfo getInfo()
    {
        return getInfo(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default AccountInfo getInfo(java.util.Map<String, String> context)
    {
        return _iceI_getInfoAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<AccountInfo> getInfoAsync()
    {
        return _iceI_getInfoAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<AccountInfo> getInfoAsync(java.util.Map<String, String> context)
    {
        return _iceI_getInfoAsync(context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<AccountInfo> _iceI_getInfoAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<AccountInfo> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getInfo", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     AccountInfo ret;
                     ret = AccountInfo.ice_read(istr);
                     return ret;
                 });
        return f;
    }
    ...
    {
        return "::gAccounts::StandardAccount";
    }
}
